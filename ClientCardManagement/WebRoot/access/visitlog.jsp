...
<script type="text/javascript">
				...
				$("#del").click( function(event) {
					var href = "access/DeleteTrnAccessAction";
					$this = $(this);
		...
		<form id="pagerForm" method="post"
			action=<s:if test="'false'==isSearchFlag">
						"access/GetListTrnAccessAction"</s:if>
			<s:else>
					"access/VisitLogSearchAction?usernam=${usernam}&comjnam=${comjnam}&finam=${finam}&begintime=${begintime}&endtime=${endtime}"
				</s:else>>
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="access/VisitLogSearchAction" method="post">
	<div class="searchBar">
